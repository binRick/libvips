...
static void vips_foreign_save_qoi_dispose(GObject *gobject)            {
...
static int vips_foreign_save_qoi_build(VipsObject *object)           {
...
static void vips_foreign_save_qoi_class_init(VipsForeignSaveQoiClass *class)            {
...
static void vips_foreign_save_qoi_init(VipsForeignSaveQoi *qoi)            {
}
...
static int vips_foreign_save_qoi_file_build(VipsObject *object)           {
  VipsForeignSaveQoi     *qoi  = (VipsForeignSaveQoi *)object;
...
static void vips_foreign_save_qoi_file_class_init(VipsForeignSaveQoiFileClass *class)            {
  GObjectClass     *gobject_class = G_OBJECT_CLASS(class);
  VipsObjectClass  *object_class  = (VipsObjectClass *)class;
...
static void vips_foreign_save_qoi_file_init(VipsForeignSaveQoiFile *file)            {
}
...
static int vips_foreign_save_qoi_target_build(VipsObject *object)           {
  VipsForeignSaveQoi       *qoi    = (VipsForeignSaveQoi *)object;
...
static void vips_foreign_save_qoi_target_class_init(VipsForeignSaveQoiTargetClass *class)                                            {
  GObjectClass     *gobject_class = G_OBJECT_CLASS(class);
  VipsObjectClass  *object_class  = (VipsObjectClass *)class;
  VipsForeignClass *foreign_class = (VipsForeignClass *)class;
...
static void vips_foreign_save_qoi_target_init(VipsForeignSaveQoiTarget *target)            {
}
