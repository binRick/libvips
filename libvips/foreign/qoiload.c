...
static gboolean vips_foreign_load_qoi_is_a_source(VipsSource *source)                {
...
static void vips_foreign_load_qoi_dispose(GObject *gobject)            {
 ...
 */
static int vips_foreign_load_qoi_parse_header(VipsForeignLoadQoi *qoi)           {
  VipsObjectClass *class = VIPS_OBJECT_GET_CLASS(qoi);

  return(0);
}

static VipsForeignFlags vips_foreign_load_qoi_get_flags(VipsForeignLoad *load)                        {
...
static int vips_foreign_load_qoi_header(VipsForeignLoad *load)           {
  VipsForeignLoadQoi *qoi = (VipsForeignLoadQoi *)load;
 ...
 */
static VipsImage *vips_foreign_load_qoi_map(VipsForeignLoadQoi *qoi)                  {
...
static int vips_foreign_load_qoi_load(VipsForeignLoad *load)           {
  VipsForeignLoadQoi *qoi = (VipsForeignLoadQoi *)load;
...
static void vips_foreign_load_qoi_class_init(VipsForeignLoadQoiClass *class)            {
...
static void vips_foreign_load_qoi_init(VipsForeignLoadQoi *qoi)            {
  qoi->scale = 1.0;
}
...
static gboolean vips_foreign_load_qoi_file_is_a(const char *filename)                {
  VipsSource *source;
  gboolean   result;
...
static int vips_foreign_load_qoi_file_build(VipsObject *object)           {
...
static void vips_foreign_load_qoi_file_class_init(VipsForeignLoadQoiClass *class)            {
  GObjectClass         *gobject_class = G_OBJECT_CLASS(class);
  VipsObjectClass      *object_class  = (VipsObjectClass *)class;
  VipsForeignLoadClass *load_class    = (VipsForeignLoadClass *)class;
...
static void vips_foreign_load_qoi_file_init(VipsForeignLoadQoiFile *file)            {
}
...
static int vips_foreign_load_qoi_source_build(VipsObject *object)           {
  VipsForeignLoadQoi       *qoi    = (VipsForeignLoadQoi *)object;
...
static void vips_foreign_load_qoi_source_class_init(VipsForeignLoadQoiFileClass *class)            {
  GObjectClass         *gobject_class   = G_OBJECT_CLASS(class);
  VipsObjectClass      *object_class    = (VipsObjectClass *)class;
  VipsOperationClass   *operation_class = VIPS_OPERATION_CLASS(class);
  VipsForeignLoadClass *load_class      = (VipsForeignLoadClass *)class;
...
static void vips_foreign_load_qoi_source_init(VipsForeignLoadQoiSource *source)            {
}
