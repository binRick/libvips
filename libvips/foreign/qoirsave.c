...
static void vips_foreign_save_qoir_dispose(GObject *gobject)            {
...
static void vips_foreign_save_qoir_init(VipsForeignSaveQoir *qoir)            {
}
...
static int vips_foreign_save_qoir_file_build(VipsObject *object)           {
  VipsForeignSaveQoir     *qoir = (VipsForeignSaveQoir *)object;
...
static void vips_foreign_save_qoir_file_class_init(VipsForeignSaveQoirFileClass *class)            {
  GObjectClass     *gobject_class = G_OBJECT_CLASS(class);
  VipsObjectClass  *object_class  = (VipsObjectClass *)class;
...
static void vips_foreign_save_qoir_file_init(VipsForeignSaveQoirFile *file)            {
}
...
static int vips_foreign_save_qoir_target_build(VipsObject *object)           {
  VipsForeignSaveQoir       *qoir   = (VipsForeignSaveQoir *)object;
...
static void vips_foreign_save_qoir_target_class_init(VipsForeignSaveQoirTargetClass *class)                                             {
  GObjectClass     *gobject_class = G_OBJECT_CLASS(class);
  VipsObjectClass  *object_class  = (VipsObjectClass *)class;
  VipsForeignClass *foreign_class = (VipsForeignClass *)class;
